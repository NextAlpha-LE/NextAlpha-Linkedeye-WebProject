...
(function () {
    ...
    Client = (function () {
        ...
        function Client(ws_fn) {
            ...
            this.reconnect_delay = 5000;  //default reconnect_delay is 0
            this.counter = 0;
            this.connected = false;
            this.heartbeat = {
                outgoing: 10000,
                incoming: 0   //default incoming is 10000
            };
            this.maxWebSocketFrameSize = 16 * 1024;
            this.subscriptions = {};
            this.partialData = '';
          //  console.log("Client--->" + JSON.stringify(ws_fn))
        }
        ...
        Client.prototype._setupHeartbeat = function (headers) {
         //   console.log("_setupHeartbeat--date and time ------>"+new Date().toLocaleString().replace(',', ''));
          //  console.log("_setupHeartbeat---->" + JSON.stringify(headers))
        ...
        Client.prototype._connect = function () {
            ...
            this.ws.onclose = (function (_this) {
                return function (closeEvent) {
                    //console.log("date and time close ------>" + new Date().toLocaleString().replace(',', ''));
                  //  console.log("closeEvent---->")
                    var msg;
                    msg = "Whoops! Lost connection to " + _this.ws.url + ' reason: ' + closeEvent.code + ' ' + closeEvent.reason;;
                    if (typeof _this.debug === "function") {
                        _this.debug(msg);
                    }
        ...
        Client.prototype.disconnect = function (disconnectCallback, headers) {
          ...
          //  console.log("disconnectCallback---->" + this._disconnectCallback)
            this._active = false;
            if (this.connected) {
                if (!headers.receipt) {
    ...
    Stomp = {
        ...
        client: function (url, protocols) {
          //  console.log("klass-url-->" + url)
          //  console.log("klass-protocols-->" + protocols)
            var ws_fn;
            if (protocols == null) {
                protocols = ['v10.stomp', 'v11.stomp', 'v12.stomp'];
            }
          //  console.log("klass-protocols-if->" + protocols)
            ws_fn = function () {
                var klass;
                klass = Stomp.WebSocketClass || WebSocket;
               // console.log("klass--->" + klass)
                return new klass(url, protocols);
               // console.log("return--klass--->" + klass(url, protocols))
            };
           // console.log("ws_fn-ws_fn-->" + JSON.stringify(ws_fn))
           // console.log("Client(ws_fn)-->" + Client(ws_fn))
