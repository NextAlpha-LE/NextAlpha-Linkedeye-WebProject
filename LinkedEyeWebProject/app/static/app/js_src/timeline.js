...
links.Timeline = function(container, options) {
    ...
    this.options = {
        ...
        'min': new Date(2021, 12, 1), // from 01/01/2022
        'max': today,
...
links.Timeline.prototype.repaintFrame = function() {
    ...
    var height = options.autoHeight ?
        ...
        ('180px' || "100%");//this is for changing timeline frame height
...
links.Timeline.ItemBox.prototype.updatePosition = function (timeline) {
    ...
    if (dom) {
        ...
        dom.style.top = this.top + 4 + "px" ;//should change rekha
        if (boxAlign == 'right') {
                ...
                while (i < iMax) {
                    ...
                    if (neighbors > maxItems) {
                        ...
                        var title = 'Cluster containing ' + count +
                            ' tickets. Zoom in to see the individual ticket. To see ticket info click on cluster and select ticket from tickets dropdown';
                        var content = '<div title="' + title + '">' + count + ' Tickets</div>';
                        ...
                        if(newTicketCount > 0)
                            cluster['className'] = 'New' //to represent the cluster contains ticket with status new.
