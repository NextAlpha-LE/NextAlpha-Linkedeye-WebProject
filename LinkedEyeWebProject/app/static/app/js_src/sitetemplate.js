...
function addSite(obj) {
    ...
    siteHtml += '<a  href="/ticket?site=' + obj.sitename + '" target="_blank">'
    siteHtml += '<button class="btn btn-default btn-ripple ml-4">'
    siteHtml += '<i class="mdi mdi-ticket-confirmation" style="color: #6c757d"></i>'
    siteHtml += '</button>'
    siteHtml += '</a>'

    siteHtml += '<button class="btn btn-default btn-ripple accordion-toggle ml-5" data-toggle="collapse" data-target="#site-detail-' + obj.id + '" onclick="userInfo(' + obj.id + ')">'
    ...
    siteHtml += '<i class="icon-more_option" style="color: #6c757d"></i>'
    siteHtml += '</button>'
    siteHtml += '<div class="dropdown-menu" aria-labelledby="moreoption">'
    //siteHtml += '<a class="dropdown-item" onclick="onDeleteSite(' + obj.id + ')"><i class="icon-delete"></i>Delete</a>'
